...
public class SentActivity extends AppCompatActivity {
    ...
    private void setSentAdapter() {
        ...
        arrayAdapter2 = new SentAdapter(SentActivity.this, smsList);
...
//
//                AlertDialog.Builder alert = new AlertDialog.Builder(SentActivity.this);
    ...
    private void setUpListeners() {
        ...
        fabOutbox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SentActivity.this, NewMessage.class);
                startActivity(i);
            }
        });
        listViewOutbox.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(SentActivity.this, SMSDetailsOutbox.class);
